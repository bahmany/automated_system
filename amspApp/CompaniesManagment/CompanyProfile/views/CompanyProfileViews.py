...
class CompanyProfileViewSet(viewsets.ModelViewSet):
    ...
    permission_name = "Can_edit_company_profile"
    permission_classes = (CanCruid,)

    def get_permissions(self):
        return get_permissions(self, CompanyProfileViewSet)
    ...
    def get_queryset(self):
        self.queryset = CompanyProfile.objects.filter(companyID = self.kwargs["companyID_id"])
    ...
    def template_page(self,request):
        return render_to_response('companyManagement/CompanyProfile/CompanyProfile.html', {},
