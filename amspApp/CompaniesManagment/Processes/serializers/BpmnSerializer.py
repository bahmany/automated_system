...
class BpmnSerializer(DocumentSerializer):
    ...
    otherTasks = serializers.ListField(required=False, allow_null=True)
    ...
    storage = serializers.DictField(allow_null=True, required=False)

    class Meta:
        model = Bpmn
        fields = ('xml', 'description', 'user_id',
                  'company_id', 'extra', 'storage',
                  'name', 'id', 'is_valid_form',
                  'form', 'processObjs', 'userTasks', 'otherTasks', 'bindingMap', 'publishedUsers',
    ...
    def update(self, instance, validated_data):
        ...
        instance.otherTasks = validated_data.get('otherTasks', instance.otherTasks)
        instance.save()
