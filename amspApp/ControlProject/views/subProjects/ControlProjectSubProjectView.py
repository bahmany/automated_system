...
class ControlProjectSubProjectTemplateView(views.APIView):
    def get(self, request, *args, **kwargs):
        return render_to_response(
            "ControlProject/SubProjects/base.html",
            {}, context_instance=RequestContext(request))


class ControlProjectSubProjectViewSet(viewsets.ModelViewSet):
    ...
    def initial(self, request, *args, **kwargs):
        ...
        return super(ControlProjectSubProjectViewSet, self).initial(request, *args, **kwargs)


    def list(self, request, *args, **kwargs):
        result = super(ControlProjectSubProjectViewSet, self).list(request, *args, **kwargs)
