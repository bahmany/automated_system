...
from amspApp.Infrustructures.MySpiffWorkflow.bpmn.parser.TaskParser import TaskParser
from amspApp.Infrustructures.MySpiffWorkflow.bpmn.parser.util import *
from amspApp.Infrustructures.MySpiffWorkflow.bpmn.specs.event_definitions import TimerEventDefinition, MessageEventDefinition
...
class ServiceParser(TaskParser):
    """
    Base class for parsing User Tasks
    """
    pass
