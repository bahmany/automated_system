...
from amspApp.Infrustructures.MySpiffWorkflow.util.compat import configparser
from io import BytesIO, TextIOWrapper
import xml.etree.ElementTree as ET
import zipfile
import os
from amspApp.Infrustructures.MySpiffWorkflow.bpmn.parser.BpmnParser import BpmnParser
...
class BpmnSerializer(Serializer):
    ...
    The BPMN package must have been created using the Packager class (from amspApp.Infrustructures.MySpiffWorkflow.bpmn.storage.Packager).
