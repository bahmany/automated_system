...
from amspApp.Infrustructures.MySpiffWorkflow.operators import valueof, Attrib, PathAttrib
from amspApp.Infrustructures.MySpiffWorkflow.util import merge_dictionary
