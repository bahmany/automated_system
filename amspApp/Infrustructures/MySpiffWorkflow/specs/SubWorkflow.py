...
import amspApp.Infrustructures.MySpiffWorkflow
...
class SubWorkflow(TaskSpec):
    ...
    def _create_subworkflow(self, my_task):
        ...
        from amspApp.Infrustructures.MySpiffWorkflow.specs import WorkflowSpec
        file           = valueof(my_task, self.file)
        serializer     = XmlSerializer()
        xml            = open(file).read()
        wf_spec        = WorkflowSpec.deserialize(serializer, xml, filename = file)
        outer_workflow = my_task.workflow.outer_workflow
        return amspApp.Infrustructures.MySpiffWorkflow.Workflow(wf_spec, parent = outer_workflow)
