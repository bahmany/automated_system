...
from amspApp.Infrustructures.MySpiffWorkflow.util.event import Event
...
class TaskSpec(object):
    ...
    def __init__(self, parent, name, **kwargs):
        ...
        :type  parent: L{amspApp.Infrustructures.MySpiffWorkflow.specs.WorkflowSpec}
    ...
    def deserialize(cls, serializer, wf_spec, s_state, **kwargs):
        ...
        :type  serializer: L{amspApp.Infrustructures.MySpiffWorkflow.storage.Serializer}
        :param serializer: The serializer to use.
        :type  wf_spec: L{amspApp.Infrustructures.MySpiffWorkflow.spec.WorkflowSpec}
