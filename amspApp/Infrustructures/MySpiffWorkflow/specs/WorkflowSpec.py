...
from amspApp.Infrustructures.MySpiffWorkflow.specs import StartTask
...
class WorkflowSpec(object):
    ...
    def get_task_spec_from_name(self, name):
        ...
        """
        taskName = self.task_specs.get(name)
        if not taskName:
            raise Exception("One element has no name, please check workflow ")
    ...
    def validate(self):
        ...
        """
        results = []
        from amspApp.Infrustructures.MySpiffWorkflow.specs import Join
    ...
    def serialize(self, serializer, **kwargs):
        ...
        :type  serializer: L{amspApp.Infrustructures.MySpiffWorkflow.storage.Serializer}
