...
class MSTemplateSerializer(DynamicFieldsDocumentSerializer):
    ...
    icon = serializers.CharField(label="icon", required=False, allow_null=True)
...
class MSTemplateInboxSerializer(DynamicFieldsDocumentSerializer):
    ...
    class Meta:
        model = MSTemplate
        fields = ('name', 'icon', 'desc', 'dataType', 'id', 'position_id')
