...
angular.module('AniTheme').controller(
    ...
    function ($scope,
        ...
        $scope.getYear = function () {
            $http.get("/api/v1/ControlProject/Year/" + $stateParams.YearID + "/").then(function (data) {
                $scope.year = data.data;
            })
        };
        $scope.getYear();

        var urlProject = "/api/v1/ControlProject/Year/" + $stateParams.YearID + "/projects/";
