...
!function (a) {
    a.jsontotable = function (b, c) {
        var d = a.extend({id: null, header: !0, className: null}, c);
        c = a.extend(d, c);
        var e = b;
        if ("string" == typeof e && (e = a.parseJSON(e)), c.id && e.length) {
            ...
            for (c.className && h.addClass(c.className), a.fn.appendTr = function (b, c) {
                var d, e, f, h, i, j = c ? "thead" : "tbody", k = c ? "th" : "td";
                ...
                g = a(g);
                for (e in b) if (f = b[e], "function" != typeof f) {
                ...
                if (c) a(this).append(a("<" + j + "></" + j + ">").append(g)); else {
