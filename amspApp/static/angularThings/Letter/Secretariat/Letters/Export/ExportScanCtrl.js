...
angular.module('AniTheme').controller(
    ...
    function ($scope,
        ...
        $scope.Post = function () {
            ...
            $http.post("/api/v1/letter/sec/export-scan/", $scope.Scan).then(function (data) {
                $scope.list();
                $scope.Clear();
            }).catch(function (data) {
        ...
        $scope.list = function () {
            $http.get("/api/v1/letter/sec/export-scan/?id=" + $stateParams.exportid).then(function (data) {
