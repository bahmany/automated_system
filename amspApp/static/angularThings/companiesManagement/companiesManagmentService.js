...
angular
    ...
    ['$cookies', '$http', '$location','$stateParams',
        function ($cookies, $http, $location, $stateParams) {
            ...
            this.companiesForCurrent = function (addressWithParam) {
                if (addressWithParam == undefined) {
                    addressWithParam = "/api/v1/companies/"+$stateParams.companyid+"/positions/CompaniesForCurrent/"
                }
                return $http.get(addressWithParam);
            };
