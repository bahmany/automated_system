...
angular.module('AniTheme').controller(
    ...
    function ($scope,
        ...
        $scope.getTmpl = function () {
            $http.get("/api/v1/CostCal/Year/" + $stateParams.YearID + "/Share/").then(function (data) {
                $scope.staticTmpl.publishedUsersDetail = data.data;
            })
        };

        $scope.updateTmpl = function () {
            $http.post("/api/v1/CostCal/Year/" + $stateParams.YearID + "/Share/", $scope.staticTmpl.publishedUsersDetail).then(function (data) {
