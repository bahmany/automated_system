...
angular.module('AniTheme').controller(
    ...
    function ($scope,
        ...
        $scope.listDates = function () {
            $http.post("/api/v1/barcodes/getdates_of_showreport1/", $scope.filter).then(function (data) {
        ...
        $scope.loadReport = function (dateOf) {
            ...
            $http.post("/api/v1/barcodes/showreport1/", {dateOf: dateOf}).then(function (data) {
