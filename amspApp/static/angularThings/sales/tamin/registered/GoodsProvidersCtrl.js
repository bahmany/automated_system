...
// -------------------------------------------------------------------------------------
        ...
        $scope.getInstance = function () {
            $scope.reset();
            $http.get("/api/v1/adminTaminDakheli/"+$stateParams.details+"/").then(function (data) {
        ...
        $scope.save = function (ev) {
            ...
            $mdDialog.show(confirm).then(function () {
                    ...
                    dtToSv.instanceID = $stateParams.details;
                    $http.post("/dashboards/api/v1/sp_save_supply/", dtToSv).then(function (data) {
                        if (data.data.msg === "ok") {
